(() => {
  ...
  const TEXT_JA = {
    ...
    "成为超级球球合作伙伴，一起改变世界": "Chio Chioのパートナーとして、新しい日常をともに",
    "超级球球兼具 AI 陪伴价值、可爱 IP 形象和礼赠属性，适合亲子、教育、礼品、潮玩零售与区域渠道共同拓展。": "Chio Chioは、AIによる寄り添い、親しみやすいキャラクター、ギフトとしての魅力を備え、親子、教育、ギフト、キャラクター雑貨、小売、地域流通など幅広い分野で展開できます。",
    "为什么选择超级球球？": "Chio Chioが選ばれる理由",
    "儿童情绪陪伴与性格养成正在成为家庭刚需，超级球球用可爱 IP、AI 心理模型和全场景礼赠属性，帮助伙伴切入更稀缺、更有复购潜力的亲子消费赛道。": "子どもの心への寄り添いと人間力の育成への関心が高まる中、Chio Chioは親しみやすいキャラクター、心理学の知見を生かしたAI、幅広いギフト用途を組み合わせ、パートナーの新しい親子市場への参入を支えます。",
    "聚焦儿童情绪陪伴与性格养成，和常规玩具、教具形成差异化，方便伙伴建立推荐理由。": "子どもの心への寄り添いと人間力の育成に特化し、一般的な玩具や教材と差別化することで、提案価値を伝えやすくします。",
    "AI 与心理学能力支撑": "AIと心理学の知見による基盤",
    "自研有爱 AI 心理陪伴系统，结合情绪识别、共情对话和长期记忆，形成产品体验壁垒。": "独自開発のYouAIシステムが、感情の手がかり、共感的な対話、長期記憶を組み合わせ、独自の製品体験を支えます。",
    "围绕拖延、急躁、怕挫折、不敢表达等高频成长问题，让家长更容易理解产品价值。": "先延ばし、いら立ち、挫折への不安、表現の苦手さなど身近な成長課題を扱い、保護者に製品価値が伝わりやすい設計です。",
    "提供产品素材、销售话术、培训内容、陈列建议和传播支持，帮助合作伙伴更快落地。": "製品素材、販売説明、研修、展示提案、広報支援を提供し、パートナーの円滑な導入を支えます。",
    "总部合作支持": "本部によるパートナー支援",
    "物料支持": "販促素材",
    "提供产品图、品牌素材、招商资料、终端陈列和活动素材。": "製品画像、ブランド素材、提携資料、店頭展示、イベント用素材を提供します。",
    "培训支持": "研修支援",
    "提供产品话术、销售异议处理、门店导购培训和渠道启动内容。": "製品説明、販売時の質問対応、店舗スタッフ研修、販売開始向けコンテンツを提供します。",
    "陈列支持": "展示支援",
    "提供空间陈列建议、样机体验方案、亲子活动脚本和本地化展示参考。": "売場づくり、デモ機の体験設計、親子イベントの進行案、地域に合わせた展示例を提供します。",
    "传播支持": "プロモーション支援",
    "配合线上线下传播、展会活动、达人内容、品牌联合营销和区域曝光。": "オンライン・オフラインの発信、展示会、クリエイターコンテンツ、共同マーケティング、地域PRに連携して取り組みます。",
    "售后支持": "アフターサポート",
    "提供客服承接、问题反馈、产品使用指引和持续迭代信息同步。": "カスタマー対応、問題の共有、使用ガイド、継続的な製品更新情報を提供します。",
    "一起做一件有温度、有价值的事": "温かく、価値ある取り組みをともに",
    "如果你拥有亲子客群、教育资源、礼赠渠道或区域服务能力，欢迎和我们聊聊如何把超级球球带到更多家庭。": "親子層との接点、教育資源、ギフト販路、地域サービスの基盤をお持ちでしたら、Chio Chioをより多くの家庭へ届ける方法をぜひご相談ください。",
    "立即咨询合作": "提携について問い合わせる",
    "新消费品类窗口": "新しい消費カテゴリーへの機会",
    "儿童情绪陪伴与性格养成正在成为家庭刚需，合作伙伴可以更早占位一个有复购、有内容、有故事的新赛道。": "子どもの心への寄り添いと人間力の育成への関心が高まっています。継続購入、コンテンツ展開、ブランドストーリーの可能性を持つ新市場に、早い段階から参入できます。",
  ...
  const TEXT_DA = {
    ...
    "成为超级球球合作伙伴，一起改变世界": "Bliv Chio Chio-partner, og skab noget nyt sammen med os",
    "超级球球兼具 AI 陪伴价值、可爱 IP 形象和礼赠属性，适合亲子、教育、礼品、潮玩零售与区域渠道共同拓展。": "Chio Chio kombinerer AI-nærvær, en elskelig karakter og en stærk gaveoplevelse. Det åbner muligheder inden for familier, uddannelse, gaver, designlegetøj, detailhandel og regionale salgskanaler.",
    "为什么选择超级球球？": "Hvorfor vælge Chio Chio?",
    "儿童情绪陪伴与性格养成正在成为家庭刚需，超级球球用可爱 IP、AI 心理模型和全场景礼赠属性，帮助伙伴切入更稀缺、更有复购潜力的亲子消费赛道。": "Flere familier efterspørger støtte til børns følelser og personlige styrker. Chio Chio kombinerer en tilgængelig karakter, psykologisk funderet AI og mange gaveanledninger og hjælper partnere ind på et nyt familiemarked med mulighed for gentagne køb.",
    "聚焦儿童情绪陪伴与性格养成，和常规玩具、教具形成差异化，方便伙伴建立推荐理由。": "Fokus på følelsesmæssig støtte og personlige styrker adskiller produktet fra almindeligt legetøj og undervisningsmidler og gør værdien lettere at formidle.",
    "AI 与心理学能力支撑": "Understøttet af AI og psykologisk viden",
    "自研有爱 AI 心理陪伴系统，结合情绪识别、共情对话和长期记忆，形成产品体验壁垒。": "Det egenudviklede YouAI-system kombinerer følelsesmæssige signaler, empatisk dialog og langtidshukommelse i en særpræget produktoplevelse.",
    "围绕拖延、急躁、怕挫折、不敢表达等高频成长问题，让家长更容易理解产品价值。": "Produktet tager fat på velkendte udfordringer som udsættelse, utålmodighed, frygt for modgang og vanskeligheder ved at udtrykke sig, så værdien er let for forældre at forstå.",
    "提供产品素材、销售话术、培训内容、陈列建议和传播支持，帮助合作伙伴更快落地。": "Vi leverer produktmateriale, salgsbudskaber, træning, udstillingsforslag og kommunikationsstøtte, så partnerne kan komme godt i gang.",
    "总部合作支持": "Partnerstøtte fra hovedkontoret",
    "物料支持": "Materialer",
    "提供产品图、品牌素材、招商资料、终端陈列和活动素材。": "Produktbilleder, brandmateriale, partnerpræsentationer samt materiale til butik og arrangementer.",
    "培训支持": "Træning",
    "提供产品话术、销售异议处理、门店导购培训和渠道启动内容。": "Produktpræsentation, håndtering af kundespørgsmål, træning af butikspersonale og indhold til kanalstart.",
    "陈列支持": "Udstillingsstøtte",
    "提供空间陈列建议、样机体验方案、亲子活动脚本和本地化展示参考。": "Forslag til butiksindretning, demooplevelser, familieaktiviteter og lokalt tilpassede udstillinger.",
    "传播支持": "Kommunikationsstøtte",
    "配合线上线下传播、展会活动、达人内容、品牌联合营销和区域曝光。": "Samarbejde om online og offline kommunikation, messer, indhold fra profiler, fælles markedsføring og regional synlighed.",
    "售后支持": "Support efter køb",
    "提供客服承接、问题反馈、产品使用指引和持续迭代信息同步。": "Kundeservice, tilbagemelding om problemer, brugervejledning og løbende information om produktopdateringer.",
    "一起做一件有温度、有价值的事": "Lad os skabe noget meningsfuldt med omtanke",
    "如果你拥有亲子客群、教育资源、礼赠渠道或区域服务能力，欢迎和我们聊聊如何把超级球球带到更多家庭。": "Har du kontakt til familier, uddannelsesressourcer, gavekanaler eller lokal servicekapacitet, taler vi gerne om, hvordan Chio Chio kan nå ud til flere hjem.",
    "立即咨询合作": "Kontakt os om et partnerskab",
    "新消费品类窗口": "Mulighed i en ny forbrugerkategori",
    "儿童情绪陪伴与性格养成正在成为家庭刚需，合作伙伴可以更早占位一个有复购、有内容、有故事的新赛道。": "Interessen for støtte til børns følelser og personlige styrker vokser. Partnere kan komme tidligt ind i en ny kategori med muligheder for gentagne køb, indhold og en tydelig fortælling.",
